...
global.ownerName = 'Jaa Elite'
global.ownerNumber = ["0@s.whatsapp.net"]
global.packname = 'Jaa'
global.author = 'Punya Xero'
global.prefa = ['','.']
global.mess = {
    wait: '*Waiting Proses !!*',
    succes: '*Succes !!*',
    ...
    owner: '*Lu Siapa Kocak :v*',
    group: '*Khusus Group Only*',
...
let buttons = [
                ...
                let buttonMessage = {
                    image: { url: 'https://telegra.ph/file/bf5d82353a46f752f33da.jpg' },
                    caption: `${jiren}`,
                    footer: `By Jaa`,
                    buttons: buttons,
                    headerType: 4
...
▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
https://chat.whatsapp.com/J5BsrIa3jKqFvYCLfutTHL
▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
...
break
case 'sc':
diablobotwhatsapp.reply(`*Susah Susah Recode Lu Mau Minta Wkwk*`)
break
...
break
case 'akses':
diablobotwhatsapp.reply(`*UNTUK AKSES BOT CHAT OWNER : wa.me/6283838077485*`)
break
case 'sewa':
diablobotwhatsapp.reply(`*UNTUK SEWA BOT CHAT OWNER : wa.me/6283838077485*`)
break
case 'masuk_ke': {
if (!itsMediablo) return diablobotwhatsapp.reply(mess.owner)
